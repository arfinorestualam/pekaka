...
public class listJobHomeAdapter extends RecyclerView.Adapter<listJobHomeAdapter.ViewHolder> {

    private ArrayList<Jobs> jobs= new ArrayList<>();
    private Context context;

    public listJobHomeAdapter(ArrayList<Jobs> jobs, Context context){
        this.jobs = jobs;
    ...
    @NonNull
    @Override
    public listJobHomeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemRow = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_home_job, parent, false);
        return new ViewHolder(itemRow);
    }


    @Override
    public void onBindViewHolder(@NonNull listJobHomeAdapter.ViewHolder holder, int position) {
